...
public class DatePickerTest {
    ...
    public void mainActivityTest2() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.button3), withText("Los Angeles"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView2), withText("PICK DATE"),
                        isDisplayed()));
        textView.check(matches(withText("PICK DATE")));
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.button6), withText("Go"),
                        isDisplayed()));
